 		...
 		function tocSetToggle(close) {
				var tocOpen = "Этот фрейм останется открытым после выбора объекта из списка. Нажмите для изменения.";
				var tocClose = "Этот фрейм закроется после выбора объекта из списка. Нажмите для изменения."
